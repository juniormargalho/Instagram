            ...
            public void onClick(View v) {
                ...
                if( !textoEmail.isEmpty() ){
                    if( !textoSenha.isEmpty() ){
                        ...
                        Toast.makeText(LoginActivity.this, "Campo senha não preenchido!", Toast.LENGTH_SHORT).show();
                    }
                }else {
                    Toast.makeText(LoginActivity.this, "Campo e-mail não preenchido!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
